...
export const PRIVATE_NAMESPACES = ["anonymous_session","attachments","channels","discord_accounts","ignored_discord_accounts","messages","search","server_preferences","servers","user_server_settings"] as const;
...
export const NAMESPACE_STRUCTURE = {
  ...
  "search": ["getRecentThreads","getServersUserHasPostedIn","getUserById","getUserComments","getUserPosts","publicSearch"],
